...
public class LikeController {
    ...
    @PostMapping("/post/unlike/{no}")
    public String unLike(@PathVariable("no") BoardEntity no, @AuthenticationPrincipal UserInfo userInfo, LikeDto likeDto, BoardDto boardDto){
//        Long UserId = userInfo.getCode();
//        String UserEmail = userInfo.getEmail();
//        likeDto.setUid(UserId);
//        likeDto.setEmail(UserEmail);
...
//        System.out.println("라이크체크 UID =" + likeDto.getUid());
        ...
        likeService.deleteLike(no, userInfo);
        return "redirect:/post/{no}";
    }
